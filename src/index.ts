...
connectDatabase.initialize()
  .then(() => {
    ...
    app.use("/api/categories", categoryRouter(connectDatabase));
    app.use("/api/team-members", teamMemberRouter(connectDatabase));
    app.use("/api/asset-library", assetLibraryRouter(connectDatabase));
