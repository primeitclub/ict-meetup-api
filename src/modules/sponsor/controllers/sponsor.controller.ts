...
export class SponsorController extends BaseController {
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const versionId =
        req.body.versionId || (req.query.versionId as string) || "system";
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const versionId =
        req.body.versionId || (req.query.versionId as string) || "system";
      const result = await this.sponsorService.update(
        req.params.id,
        req.body,
        userId,
      );
  ...
  createForCategory = async (
    ...
    try {
      ...
      return responseHandler(res)(
        "Sponsor category created successfully",
        result,
        201,
      );
    } catch (error) {
  ...
  updateForCategory = async (
    ...
    try {
      ...
      return responseHandler(res)(
        "Sponsor category updated successfully",
        result,
        200,
      );
    } catch (error) {
  ...
  deleteForCategory = async (
    ...
    try {
      ...
      return responseHandler(res)(
        "Sponsor category deleted successfully",
        null,
        200,
      );
    } catch (error) {
  ...
  getAllForCategory = async (
    ...
    try {
      ...
      return responseHandler(res)(
        "Sponsor categories fetched successfully",
        result,
        200,
      );
    } catch (error) {
  ...
  getByIdForCategory = async (
    ...
    try {
      ...
      return responseHandler(res)(
        "Sponsor category fetched successfully",
        result,
        200,
      );
    } catch (error) {
